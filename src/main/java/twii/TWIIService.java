...
public class TWIIService {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //create(list); 
        List qlist = new TWIIService().query(10.0, 5, 1);
        System.out.println(qlist.size() + "筆");
        System.out.println(qlist);
    }

    // 匯入 
    private static void create(List<TWII> list) {
    ...
    // 查詢 
    public List query(double yield, double pe, double pb) {
    ...
    // csv 轉 List 
    private static List csv() throws IOException {
        String url = "http://localhost:8080/MyJavaWebCourse/files/BWIBBU_d.csv";
        TWIIService twiib = new TWIIService();
    ...
    private static void json() throws IOException {
        String url = "http://localhost:8080/MyJavaWebCourse/files/BWIBBU_d.json";
        TWIIService twiib = new TWIIService();
